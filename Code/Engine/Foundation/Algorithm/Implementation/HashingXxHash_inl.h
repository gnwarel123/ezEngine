...
namespace ezInternal
{
  ...
  constexpr ezUInt32 ezRotLeft(ezUInt32 uiValue, ezUInt32 uiAmount) { return (uiValue << uiAmount) | (uiValue >> (32 - uiAmount)); }
  constexpr ezUInt64 ezRotLeft(ezUInt64 uiValue, ezUInt64 uiAmount) { return (uiValue << uiAmount) | (uiValue >> (64 - uiAmount)); }
