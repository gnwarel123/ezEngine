...
public:
  ...
  static void Broadcast(TransmitMode tm, ezUInt32 uiSystemID, ezUInt32 uiMsgID, ezStreamReader& out_stream, ezInt32 iDataBytes = -1);
  static void Broadcast(TransmitMode tm, ezTelemetryMessage& out_msg);

  static void SendToServer(ezUInt32 uiSystemID, ezUInt32 uiMsgID, const void* pData = nullptr, ezUInt32 uiDataBytes = 0);
  static void SendToServer(ezUInt32 uiSystemID, ezUInt32 uiMsgID, ezStreamReader& out_stream, ezInt32 iDataBytes = -1);
  static void SendToServer(ezTelemetryMessage& out_msg);
