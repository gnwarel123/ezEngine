...
public:
  ...
  static void GetAllPluginInfos(ezDynamicArray<PluginInfo>& out_infos);

  /// \internal Determines the plugin paths.
  static void GetPluginPaths(const char* szPluginName, ezStringBuilder& out_sOriginalFile, ezStringBuilder& out_sCopiedFile, ezUInt8 uiFileCopyNumber);
