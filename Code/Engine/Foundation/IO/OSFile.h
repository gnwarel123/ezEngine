...
struct EZ_FOUNDATION_DLL ezFileStats
{
  ...
  void GetFullPath(ezStringBuilder& out_sPath) const;
...
#  endif
  ...
  static ezResult CopyFolder(const char* szSourceFolder, const char* szDestinationFolder, ezDynamicArray<ezString>* pFilesCopied = nullptr);
