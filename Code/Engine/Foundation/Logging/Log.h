...
public:
  ...
  /// \brief Unregisters a previously registered receiver. It is an error to unregister a receiver that was not registered.
  static void RemoveLogWriter(ezEventSubscriptionID& out_subscriptionID);
...
public:
  ...
  static void GenerateFormattedTimestamp(TimestampMode mode, ezStringBuilder& out_sTimestampOut);
