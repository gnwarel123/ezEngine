...
namespace ezMath
{
  ...
  EZ_ALWAYS_INLINE ezUInt32 FirstBitLow(ezUInt32 uiValue)
  {
    EZ_ASSERT_DEBUG(uiValue != 0, "FirstBitLow is undefined for 0");
  ...
  EZ_ALWAYS_INLINE ezUInt32 FirstBitLow(ezUInt64 uiValue)
  {
    EZ_ASSERT_DEBUG(uiValue != 0, "FirstBitLow is undefined for 0");
  ...
  EZ_ALWAYS_INLINE ezUInt32 FirstBitHigh(ezUInt32 uiValue)
  {
    EZ_ASSERT_DEBUG(uiValue != 0, "FirstBitHigh is undefined for 0");
  ...
  EZ_ALWAYS_INLINE ezUInt32 FirstBitHigh(ezUInt64 uiValue)
  {
    EZ_ASSERT_DEBUG(uiValue != 0, "FirstBitHigh is undefined for 0");
  ...
  EZ_ALWAYS_INLINE ezUInt32 CountBits(ezUInt32 uiValue)
  {
...
#  endif
  ...
  EZ_ALWAYS_INLINE ezUInt32 CountBits(ezUInt64 uiValue)
  {
    ezUInt32 result = 0;
    result += CountBits(ezUInt32(uiValue));
    result += CountBits(ezUInt32(uiValue >> 32));
    return result;
  }

  template <typename T>
  EZ_ALWAYS_INLINE void Swap(T& out_f1, T& out_f2)
  {
    std::swap(out_f1, out_f2);
  }
  ...
  constexpr EZ_FORCE_INLINE bool IsPowerOf2(ezInt32 iValue) { return (iValue < 1) ? false : ((iValue & (iValue - 1)) == 0); }

  constexpr EZ_FORCE_INLINE bool IsPowerOf2(ezUInt32 uiValue) { return (uiValue < 1) ? false : ((uiValue & (uiValue - 1)) == 0); }
  ...
  inline ezUInt8 ColorFloatToByte(float fValue)
  {
    ...
    {
      return static_cast<ezUInt8>(Saturate(fValue) * 255.0f + 0.5f);
    }
  }

  inline ezUInt16 ColorFloatToShort(float fValue)
  {
    // Implemented according to
    // https://docs.microsoft.com/windows/desktop/direct3d10/d3d10-graphics-programming-guide-resources-data-conversion
    if (IsNaN(fValue))
    ...
    {
      return static_cast<ezUInt16>(Saturate(fValue) * 65535.0f + 0.5f);
    }
  }

  inline ezInt8 ColorFloatToSignedByte(float fValue)
  {
    // Implemented according to
    // https://docs.microsoft.com/windows/desktop/direct3d10/d3d10-graphics-programming-guide-resources-data-conversion
    if (IsNaN(fValue))
    ...
    {
      fValue = Clamp(fValue, -1.0f, 1.0f) * 127.0f;
      if (fValue >= 0.0f)
      {
        fValue += 0.5f;
      }
      ...
      return static_cast<ezInt8>(fValue);
    }
  }

  inline ezInt16 ColorFloatToSignedShort(float fValue)
  {
    // Implemented according to
    // https://docs.microsoft.com/windows/desktop/direct3d10/d3d10-graphics-programming-guide-resources-data-conversion
    if (IsNaN(fValue))
    ...
    {
      fValue = Clamp(fValue, -1.0f, 1.0f) * 32767.0f;
      if (fValue >= 0.0f)
      {
        fValue += 0.5f;
      }
      ...
      return static_cast<ezInt16>(fValue);
    }
  }

  constexpr inline float ColorByteToFloat(ezUInt8 uiValue)
  {
    // Implemented according to
    // https://docs.microsoft.com/windows/desktop/direct3d10/d3d10-graphics-programming-guide-resources-data-conversion
    return uiValue * (1.0f / 255.0f);
  }

  constexpr inline float ColorShortToFloat(ezUInt16 uiValue)
  {
    // Implemented according to
    // https://docs.microsoft.com/windows/desktop/direct3d10/d3d10-graphics-programming-guide-resources-data-conversion
    return uiValue * (1.0f / 65535.0f);
  }

  constexpr inline float ColorSignedByteToFloat(ezInt8 iValue)
  {
    // Implemented according to
    // https://docs.microsoft.com/windows/desktop/direct3d10/d3d10-graphics-programming-guide-resources-data-conversion
    return (iValue == -128) ? -1.0f : iValue * (1.0f / 127.0f);
  }

  constexpr inline float ColorSignedShortToFloat(ezInt16 iValue)
  {
    // Implemented according to
    // https://docs.microsoft.com/windows/desktop/direct3d10/d3d10-graphics-programming-guide-resources-data-conversion
    return (iValue == -32768) ? -1.0f : iValue * (1.0f / 32767.0f);
  }
...
constexpr EZ_FORCE_INLINE ezInt32 ezMath::FloatToInt(float fValue)
{
  return static_cast<ezInt32>(fValue);
}
