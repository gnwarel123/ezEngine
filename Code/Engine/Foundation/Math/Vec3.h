...
public:
  ...
  static ezVec3Template<Type> CreateRandomPointInSphere(ezRandom& out_rng); // [tested]

  /// \brief Creates a random direction vector. The vector is normalized.
  static ezVec3Template<Type> CreateRandomDirection(ezRandom& out_rng); // [tested]
  ...
  static ezVec3Template<Type> CreateRandomDeviationX(ezRandom& out_rng, const ezAngle& maxDeviation); // [tested]
  ...
  /// The deviation angle must be larger than zero.
  static ezVec3Template<Type> CreateRandomDeviationY(ezRandom& out_rng, const ezAngle& maxDeviation); // [tested]
  ...
  /// The deviation angle must be larger than zero.
  static ezVec3Template<Type> CreateRandomDeviationZ(ezRandom& out_rng, const ezAngle& maxDeviation); // [tested]
  ...
  static ezVec3Template<Type> CreateRandomDeviation(ezRandom& out_rng, const ezAngle& maxDeviation, const ezVec3Template<Type>& vNormal); // [tested]
};
