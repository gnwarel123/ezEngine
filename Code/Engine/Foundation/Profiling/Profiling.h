...
public:
  ...
  struct EZ_FOUNDATION_DLL ProfilingData
  {
    ...
    ezResult Write(ezStreamWriter& out_outputStream) const;
...
public:
  ...
  static void AddGPUScope(const char* szName, ezTime beginTime, ezTime endTime, ezUInt32 uiGpuIndex = 0);
};
...
#  define EZ_PROFILE_SCOPE(szScopeName) ezProfilingScope EZ_CONCAT(_ezProfilingScope, EZ_SOURCE_LINE)(szScopeName, EZ_SOURCE_FUNCTION, ezTime::Zero())
