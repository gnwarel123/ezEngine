...
public:
  ...
  static void GetRootedPathParts(ezStringView sPath, ezStringView& out_sRoot, ezStringView& out_sRelPath); // [tested]
  ...
  static void MakeValidFilename(ezStringView sFilename, ezUInt32 uiReplacementCharacter, ezStringBuilder& out_sOutFilename);
