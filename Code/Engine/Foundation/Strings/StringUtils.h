...
public:
  ...
  static void GetCharacterAndElementCount(const char* szUtf8, ezUInt32& out_uiCharacterCount, ezUInt32& out_uiElementCount,
  ...
  static ezUInt32 ToUpperString(char* szString, const char* pStringEnd = ezUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Converts a (UTF-8) string in-place to lower case.
  ///
  /// Returns the new string length in bytes (it might shrink, but never grow), excluding the \0 terminator.
  static ezUInt32 ToLowerString(char* szString, const char* pStringEnd = ezUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  static void Trim(const char*& out_pString, const char*& out_pStringEnd, const char* szTrimCharsStart,
  ...
  static bool IsValidIdentifierName(const char* pString, const char* pStringEnd = ezUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  static void OutputFormattedInt(char* szOutputBuffer, ezUInt32 uiBufferSize, ezUInt32& out_uiWritePos, ezInt64 iValue, ezUInt8 uiWidth, bool bPadZeros, ezUInt8 uiBase);
  /// \brief [internal] Prefer to use snprintf.
  static void OutputFormattedUInt(char* szOutputBuffer, ezUInt32 uiBufferSize, ezUInt32& out_uiWritePos, ezUInt64 uiValue, ezUInt8 uiWidth, bool bPadZeros,
    ezUInt8 uiBase, bool bUpperCase);
  /// \brief [internal] Prefer to use snprintf.
  static void OutputFormattedFloat(char* szOutputBuffer, ezUInt32 uiBufferSize, ezUInt32& out_uiWritePos, double fValue, ezUInt8 uiWidth, bool bPadZeros,
