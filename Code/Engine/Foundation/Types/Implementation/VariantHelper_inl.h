...
auto ezVariant::DispatchTo(Functor& out_functor, Type::Enum type, Args&&... args)
{
  switch (type)
  {
    case Type::Bool:
      CALL_FUNCTOR(out_functor, bool);
      break;

    case Type::Int8:
      CALL_FUNCTOR(out_functor, ezInt8);
      break;

    case Type::UInt8:
      CALL_FUNCTOR(out_functor, ezUInt8);
      break;

    case Type::Int16:
      CALL_FUNCTOR(out_functor, ezInt16);
      break;

    case Type::UInt16:
      CALL_FUNCTOR(out_functor, ezUInt16);
      break;

    case Type::Int32:
      CALL_FUNCTOR(out_functor, ezInt32);
      break;

    case Type::UInt32:
      CALL_FUNCTOR(out_functor, ezUInt32);
      break;

    case Type::Int64:
      CALL_FUNCTOR(out_functor, ezInt64);
      break;

    case Type::UInt64:
      CALL_FUNCTOR(out_functor, ezUInt64);
      break;

    case Type::Float:
      CALL_FUNCTOR(out_functor, float);
      break;

    case Type::Double:
      CALL_FUNCTOR(out_functor, double);
      break;

    case Type::Color:
      CALL_FUNCTOR(out_functor, ezColor);
      break;

    case Type::ColorGamma:
      CALL_FUNCTOR(out_functor, ezColorGammaUB);
      break;

    case Type::Vector2:
      CALL_FUNCTOR(out_functor, ezVec2);
      break;

    case Type::Vector3:
      CALL_FUNCTOR(out_functor, ezVec3);
      break;

    case Type::Vector4:
      CALL_FUNCTOR(out_functor, ezVec4);
      break;

    case Type::Vector2I:
      CALL_FUNCTOR(out_functor, ezVec2I32);
      break;

    case Type::Vector3I:
      CALL_FUNCTOR(out_functor, ezVec3I32);
      break;

    case Type::Vector4I:
      CALL_FUNCTOR(out_functor, ezVec4I32);
      break;

    case Type::Vector2U:
      CALL_FUNCTOR(out_functor, ezVec2U32);
      break;

    case Type::Vector3U:
      CALL_FUNCTOR(out_functor, ezVec3U32);
      break;

    case Type::Vector4U:
      CALL_FUNCTOR(out_functor, ezVec4U32);
      break;

    case Type::Quaternion:
      CALL_FUNCTOR(out_functor, ezQuat);
      break;

    case Type::Matrix3:
      CALL_FUNCTOR(out_functor, ezMat3);
      break;

    case Type::Matrix4:
      CALL_FUNCTOR(out_functor, ezMat4);
      break;

    case Type::Transform:
      CALL_FUNCTOR(out_functor, ezTransform);
      break;

    case Type::String:
      CALL_FUNCTOR(out_functor, ezString);
      break;

    case Type::StringView:
      CALL_FUNCTOR(out_functor, ezStringView);
      break;

    case Type::DataBuffer:
      CALL_FUNCTOR(out_functor, ezDataBuffer);
      break;

    case Type::Time:
      CALL_FUNCTOR(out_functor, ezTime);
      break;

    case Type::Uuid:
      CALL_FUNCTOR(out_functor, ezUuid);
      break;

    case Type::Angle:
      CALL_FUNCTOR(out_functor, ezAngle);
      break;

    case Type::VariantArray:
      CALL_FUNCTOR(out_functor, ezVariantArray);
      break;

    case Type::VariantDictionary:
      CALL_FUNCTOR(out_functor, ezVariantDictionary);
      break;

    case Type::TypedObject:
      CALL_FUNCTOR(out_functor, ezTypedObject);
      break;
    ...
    case Type::TypedPointer:
      CALL_FUNCTOR(out_functor, ezTypedPointer);
      break;
  }
}
