...
public:
  ...
  static void SplitCommandLineString(const char* szCommandString, bool bAddExecutableDir, ezDynamicArray<ezString>& out_outArgs, ezDynamicArray<const char*>& out_outArgsV);
