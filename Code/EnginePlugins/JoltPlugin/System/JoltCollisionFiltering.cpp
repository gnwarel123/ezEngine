...
namespace ezJoltCollisionFiltering
{
  ...
  void LoadCollisionFilters()
  {
    ...
    if (s_CollisionFilterConfig.Load("RuntimeConfigs/CollisionLayers.cfg").Failed() && s_CollisionFilterConfig.Load("CollisionLayers.cfg").Failed())
    {
  ...
  ezUInt32 GetBroadphaseCollisionMask(ezJoltBroadphaseLayer broadphase)
  {
    ...
    switch (broadphase)
    {
      ...
      case Ragdoll:
        return EZ_BIT(ezJoltBroadphaseLayer::Static) | EZ_BIT(ezJoltBroadphaseLayer::Dynamic) | EZ_BIT(ezJoltBroadphaseLayer::Ragdoll) | EZ_BIT(ezJoltBroadphaseLayer::Rope);
